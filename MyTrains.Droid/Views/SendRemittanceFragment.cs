...
namespace MyTrains.Droid.Views
{
    ...
    [Register("mytrains.droid.views.SendRemittanceFragment")]
    public class SendRemittanceFragment : MvxFragment<SendRemittanceViewModel>
    {
        ...
        public override View OnCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState)
        {
            ...
            return this.BindingInflate(Resource.Layout.SendRemittanceView, null);
        }
